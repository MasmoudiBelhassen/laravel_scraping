...
<head>
    ...
    <link href="{{asset('vendor/bootstrap/css/user.css')}}" rel="stylesheet">
    ...
    <!-- main core CSS-->
    <link href="{{asset('vendor/bootstrap/css/bootstrap-multiselect.css')}}" rel="stylesheet">
    <link href="{{asset('css/main.css')}}" rel="stylesheet">
    <!-- DataTable Bootstrap 4 core CSS-->
    <link href="{{asset('vendor/bootstrap/css/dataTables.bootstrap4.css')}}" rel="stylesheet">
    <link href="{{asset('swal/sweet-alert.css')}}" rel="stylesheet">
    <script type="text/javascript">

        /* Verfy If Adress Web Exist*/
        function myfunction() {
            var x = document.getElementById("url").value;
            var form = document.getElementById("formUrl");
            var data = $("#formUrl").serialize();
            $.ajax({
                type: 'get',
                url: 'verif',
                data: data,
                ...
                success: function (data) {
                    ...
                    if (data)
                    {
                        document.getElementById("msg").innerHTML = "<i style='color:green' class='fa fa-check-circle'></i>";
                    }
                    else
                    {
                        document.getElementById("msg").innerHTML = " <i style='color:red' class='fa fa-remove'></i>";
                    }
                },
            })
        }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="">Smart_Mag</a>
        ...
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
                ...
                <ul class="sidenav-second-level collapse" id="collapseMulti">
                    ...
                    <li>
                        <a href="{{route('interests.index')}}">Center of interest</a>
                    </li>

                    <li>
                        <a href="{{URL::to('source')}}">Add New Sources</a>
                    </li>
                    <li>
                        <a href="{{route('typeSource.index')}}">Update Type Source</a>
                    </li>

                    <li>
                        <a href="{{URL::to('selectTypeSource')}}">Add URLs From Exist Source</a>
                    </li>

                    <li>
                        <a href="{{URL::to('index2')}}">Update Scraping Information</a>
                    </li>
